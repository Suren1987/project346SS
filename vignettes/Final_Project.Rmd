...
```{r, warning = FALSE, echo = FALSE, eval=FALSE, message = FALSE, fig.width=8.0, fig.height=6.0, fig.align = "center"}
...
```
![](C:\Users\Surendra Shrestha\Documents\GEOG346_Project\project346SS\Final_Output\Rim_LST.png)
...
ggplot(LST_statsf %>% select(date, mean)) + geom_line(aes_string("date", "mean")) +
  xlab("")
```
![](C:\Users\Surendra Shrestha\Documents\GEOG346_Project\project346SS\Final_Output\LST_TS.png)
Figure 4: Time series graph of mean values of GPP for each year from 2010 to 2016.


```{r, warning = FALSE, echo = FALSE, eval=FALSE, message = FALSE, fig.width=8.0, fig.height=6.0, fig.align = "left"}
...
```
![](C:\Users\Surendra Shrestha\Documents\GEOG346_Project\project346SS\Final_Output\GPP.png)
...
ggplot(GPP_statsf %>% select(date, mean)) + geom_line(aes_string("date", "mean")) +
  xlab("")
```
![](C:\Users\Surendra Shrestha\Documents\GEOG346_Project\project346SS\Final_Output\GPP_TS.png)
